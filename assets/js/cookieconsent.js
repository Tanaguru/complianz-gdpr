  ...
  cc.Popup = (function() {
    ...
    var defaultOptions = {
      ...
      elements: {
		...
		/**
	   	 * #start-tng-a11y
		 * Transform `span` into `div` because there are `p` elements inside.
		 * Fix the use of `aria-label`, `role="button"` and `tabindex` attributes
		 */
        ...
        link: '<a class="cc-link" href="{{href}}" target="_blank">{{link}}</a>',
	  ...
	  /**
	   * #start-tng-a11y
	   * Remove these inappropriate attributes `role="dialog" aria-label="cookieconsent" aria-describedby="cookieconsent:desc"`
	   */
	  window: '<div id="cc-window" data-nosnippet="true" class="cc-window {{classes}}"><!--googleoff: all-->{{children}}<!--googleon: all--></div>',
	  /** #end-tng-a11y */
